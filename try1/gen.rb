...
ABILITIES = {
  ...
  'STR' => os(point: Point.new(120, 100), t: 'N', name: 'Strength'),
  'INT' => os(point: Point.new(420, 100), t: 'N', name: 'Intelligence'),
  'CON' => os(point: Point.new(125, 300), t: 'W', name: 'Constitution'),
  'WIS' => os(point: Point.new(425, 300), t: 'E', name: 'Wisdom'),
  'DEX' => os(point: Point.new(120, 500), t: 'W', name: 'Dexterity'),
  'CHA' => os(point: Point.new(420, 500), t: 'E', name: 'Charisma'),

  'for' => os(point: Point.new(270,  70), t: 'n', name: 'fortitude'),
  'wil' => os(point: Point.new(340, 160), t: 'n', name: 'will'),
  'lea' => os(point: Point.new(455, 200), t: 'w', name: 'learning'),
  'dri' => os(point: Point.new(190, 160), t: 'e', name: 'drive'),
  'phy' => os(point: Point.new(100, 220), t: 'w', name: 'physical'),
  'eva' => os(point: Point.new(315, 400), t: 'e', name: 'evasion'),
  'wit' => os(point: Point.new(515, 270), t: 'w', name: 'wit'),
  'pre' => os(point: Point.new(230, 400), t: 'e', name: 'presence'),
  'per' => os(point: Point.new(270, 530), t: 'n', name: 'performance'),
  'men' => os(point: Point.new(450, 370), t: 'w', name: 'mental'),
  'end' => os(point: Point.new(270, 350), t: 'n', name: 'endurance'),
  'imp' => os(point: Point.new(260, 240), t: 'e', name: 'impulse'),
  'xxx' => os(point: Point.new(320, 300), t: 'n', name: 'xxx'),
  'bal' => os(point: Point.new(105, 380), t: 'e', name: 'balance'),
  'coo' => os(point: Point.new( 35, 280), t: 'e', name: 'coordination'),
}
